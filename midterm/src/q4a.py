...
def entropy(aligned_chars, param_tuple):
    ...
    :param param_tuple: an unused tuple for function pointer compat.
    """
    e = 0.0
...
print('Sum of Pairs = {0}'.format(ma.sum_aligned_char_scores(sum_of_pairs, h)))
...
print('Sum of Pairs = {0}'.format(gma.sum_aligned_char_scores(sum_of_pairs, h)))